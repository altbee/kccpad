...
interface IKoffeeSwapRouter {
    ...
    function removeLiquidityKCS(
        ...
        address to,
        uint256 deadline
    ) external returns (uint256 amountToken, uint256 amountKCS);
    ...
    function swapExactKCSForTokens(
        uint256 amountOutMin,
        address[] calldata path,
        address to,
        uint256 deadline
    ...
    function swapTokensForExactKCS(
        uint256 amountOut,
        uint256 amountInMax,
        address[] calldata path,
        address to,
    ...
    function swapExactTokensForKCS(
        uint256 amountIn,
        uint256 amountOutMin,
        address[] calldata path,
        address to,
    ...
    function swapKCSForExactTokens(
        uint256 amountOut,
        address[] calldata path,
        address to,
        uint256 deadline
    ...
    function removeLiquidityKCSSupportingFeeOnTransferTokens(
        ...
        address to,
        uint256 deadline
    ) external returns (uint256 amountKCS);
